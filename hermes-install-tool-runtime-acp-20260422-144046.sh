...
TOS_PLUGIN_URL="${TOS_PLUGIN_URL:-https://haoxingjun-test.tos-cn-beijing.volces.com/openclaw-plugin-hermes-1.0.0-minimal-reasoning-bridge-20260422-144046.tgz}"
